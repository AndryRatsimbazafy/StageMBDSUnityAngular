...
import { ModalHallComponent } from '../modal-hall/modal-hall.component';

@Component({
  selector: 'app-modal-hall-engie',
  templateUrl: './modal-hall-engie.component.html',
  styleUrls: ['./modal-hall-engie.component.css']
})
export class ModalHallEngieComponent implements OnInit {
